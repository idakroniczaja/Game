class Obstacle {
  ...
  drawObstacle() {
     if(this.y > 30 &&  this.y < canvas.height-this.radius)
     
this.game.context.drawImage(this.img, this.width*this.spriteX, this.height*this.spriteY, this.width, this.height, this.x-50, this.y-50, this.width/5, this.height/5);
